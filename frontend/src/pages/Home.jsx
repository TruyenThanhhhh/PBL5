      ...
      <header className="flex items-center justify-between py-4 px-6 md:px-12 bg-white sticky top-0 z-50">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex gap-6 text-[13px] font-semibold text-gray-500">
            <a href="#" className="text-[#ff4d4f] border-b-2 border-[#ff4d4f] pb-1">Explore Map</a>
        ...
        <section className="px-6 md:px-12 py-16 flex flex-col md:flex-row items-center justify-between gap-12 max-w-[1400px] mx-auto">
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <button className="bg-[#ff4d4f] text-white font-bold py-3.5 px-8 rounded-xl shadow-lg shadow-[#ff4d4f]/30 hover:bg-[#e04345] transition-all">
                Explore Map
              </button>
              <button className="bg-white text-gray-800 font-bold py-3.5 px-8 rounded-xl shadow-md border border-gray-100 hover:bg-gray-50 transition-all">
                Join Community
              </button>
            </div>
          </div>
        ...
        <section className="bg-gray-50 px-6 md:px-12 py-16">
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-end mb-8">
              ...
              <a href="#" className="text-[#00897b] font-bold text-sm flex items-center gap-1 hover:underline">
        ...
        <section className="px-6 md:px-12 py-12">
          <div className="max-w-[1200px] mx-auto bg-gradient-to-br from-[#ef4444] to-[#f43f5e] rounded-[40px] p-16 text-center text-white shadow-xl shadow-red-500/20">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <button className="bg-transparent border-2 border-white text-white font-bold py-3.5 px-8 rounded-xl hover:bg-white/10 transition-colors">
                Explore Now
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-xs font-semibold text-gray-500">
              <li><a href="#" className="hover:text-[#ff4d4f]">Explore Map</a></li>
              <li><a href="#" className="hover:text-[#ff4d4f]">Community</a></li>
              <li><a href="#" className="hover:text-[#ff4d4f]">Destinations</a></li>
            </ul>
          </div>

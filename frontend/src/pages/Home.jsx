...
const copy = {
  ...
  en: {
    ...
    communityPins: 'community pins',    hiddenGems: 'hidden gems',
        ...
        <section className="bg-gray-50 px-6 md:px-12 py-16">
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-end mb-8">
              <div>
                <span className="bg-[#b2ebf2] text-[#00838f] text-[10px] font-extrabold uppercase tracking-widest px-3 py-1 rounded-full mb-3 inline-block">
                  {t.trending}
                </span>

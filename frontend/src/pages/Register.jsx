          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            {[
              ...
              <div key={placeholder} className="relative">
                ...
                <input 
                  ...
                  className="block w-full pl-10 pr-3 py-3 bg-[#f4f4f5] border-transparent rounded-xl text-sm focus:ring-2 focus:ring-[#f44336]/20 focus:bg-white transition-all placeholder-gray-400 font-medium" 
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="block w-full pl-10 pr-10 py-3 bg-[#f4f4f5] border-transparent rounded-xl text-sm focus:ring-2 focus:ring-[#f44336]/20 focus:bg-white transition-all placeholder-gray-400 font-medium" 
